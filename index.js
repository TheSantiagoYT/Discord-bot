...
const commands = [
    new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('descripcion').setDescription('Descripción, usa | para saltos de línea').setRequired(false))
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('nombre').setDescription('Nombre del embed').setRequired(false))
        .addChannelOption(option => option.setName('canal').setDescription('Canal donde enviarlo').setRequired(false)),
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(option => option.setName('nombre').setDescription('Nombre del embed a editar').setRequired(false))
