...
client.on('interactionCreate', async (interaction) => {
    ...
    if (commandName === 'embed') {
        let nombre = interaction.options.getString('nombre') || `embed_${Date.now()}`;
...
client.login(config.token); // Para pruebas locales, en nube usar process.env.TOKEN
