...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(opt => opt.setName('nombre').setDescription('Nombre del embed a eliminar').setRequired(false)),
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption(opt => opt.setName('nombre').setDescription('Nombre del embed guardado').setRequired(false))
        .addChannelOption(opt => opt.setName('canal').setDescription('Canal donde enviarlo').setRequired(false))
].map(cmd => cmd.toJSON());
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (commandName === 'embed') {
        ...
        if (descripcion) embed.setDescription(descripcion.replace(/\\n/g, '\n'));
